! function (e) {
    function t(t) {
        for (var o, a, u = t[0], c = t[1], f = t[2], p = 0, s = []; p < u.length; p++) a = u[p], r[a] && s.push(r[a][0]), r[a] = 0;
    ...
    18: function (e, t, n) {
        ...
        var g = new(o = Object(p.a)({
                ...
                function t() {
                    return O(this, t), v(this, w(t).apply(this, arguments))
                }
                return j(t, a["a"]), t
            }()) || r) || r),
        ...
        x.to(".overlay", .6, {
            ...
            y: 0,
            ease: Power3.easeOut
        }, "-=0.4"), x.add(P.show, "-=2"), b.a.onHide(function (e) {
            var t = new TimelineLite;
            t.to(g.lookAt, 2, {
                y: -6,
                ease: Power3.easeInOut
            }), t.add(P.hide, 0), t.add(S.stop), t.to(".overlay", .5, {
                autoAlpha: 1,
                onComplete: e
            }, "-=1.5")
        })
